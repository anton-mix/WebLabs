 ...
 * 
 */
@WebServiceClient(name = "SoapManager", targetNamespace = "http://Lab1/", wsdlLocation = "http://localhost:8080/WebLab3/SoapManager?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPMANAGER_QNAME = new QName("http://Lab1/", "SoapManager");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebLab3/SoapManager?wsdl");
    ...
    public SoapManager getSoapManagerPort() {
        return super.getPort(new QName("http://Lab1/", "SoapManagerPort"), SoapManager.class);
    }
    ...
    public SoapManager getSoapManagerPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Lab1/", "SoapManagerPort"), SoapManager.class, features);
    }
